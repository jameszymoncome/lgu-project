...
function PAR_ICS2() {
  ...
  const TextInput = () => {
    return (
      <div className="input-container" style={{ display: "flex",gap: "20px", alignItems: "center", marginTop: "10px"}}>
        {/* First Input */}
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <label htmlFor="entity-name" className="label">Entity Name:</label>
          <input
            type="text"
            id="entity-name"
        ...
        {/* Second Input */}
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <label htmlFor="fund-cluster" className="label">Fund Cluster:</label>
          <input
            type="text"
            id="fund-cluster"
            className="text-input"
